...
<a href="https://discord.gg/WqRs5w8y"><img src="website/resources/discord.png" style = "width: 87px; height: 20px;"/></a>
...
9. "Your wish is my command". A distributed executor service. If you can represent your job as a Docker image we will run it. You develop it, we run it. [genie-executor](https://github.com/radumarias/genie-executor)
